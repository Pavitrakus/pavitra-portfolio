      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-5 text-xl text-gray-800 space-y-4">
          ...
          <p className="leading-relaxed">
            ...
            I&apos;m the founder of <button onClick={() => setShowPaxusDesc(!showPaxusDesc)} className="font-serif font-bold text-black hover:underline cursor-pointer focus:outline-none align-baseline">PaXus</button>
            {showPaxusDesc && (
              <span className="text-gray-600 text-lg transition-all duration-300">
            ...
            {" "}and <a href="https://byteforge.space" target="_blank" rel="noopener noreferrer" className="font-playfair font-semibold text-black hover:underline">byteforge</a><span className="text-[#39FF14] font-black font-serif select-none">.</span> My ultimate goal is to build something massive and make a serious dent in <a href="https://www.google.com/search?q=Silicon+Valley" target="_blank" rel="noopener noreferrer" className="text-blue-600 font-bold hover:underline transition-colors">Silicon Valley</a>.
          </p>
