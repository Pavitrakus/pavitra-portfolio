...
export function Hero() {
  return (
    <>
      ...
      <svg className="fill-[var(--background)] transition-colors duration-300 -mt-10 h-10 sm:-mt-12 sm:h-12 max-w-6xl mx-auto relative z-10" width="100%" height="59" viewBox="0 0 1152 59" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
      ...
      <svg className="fill-white -mt-px h-10 sm:h-12 max-w-6xl mx-auto relative z-20" width="100%" height="100" viewBox="0 0 1152 59" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
