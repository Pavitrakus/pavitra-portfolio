...
export function Hero() {
  return (
    <>
      ...
      <svg className="fill-stone-100 -mt-6 h-6 sm:-mt-12 sm:h-12 max-w-6xl mx-auto" width="100%" height="59" viewBox="0 0 1152 59" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
